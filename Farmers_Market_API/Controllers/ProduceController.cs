...
namespace Farmers_Market_API.Controllers
{
    ...
    public class ProduceController : ControllerBase
    {
        ...
        [
            new (1, 1, "Tomatoes", "Vegetables", 2.5, 100, false, DateTime.Now.AddDays(-10), DateTime.Now.AddDays(-5), "Freshly harvested tomatoes."),
            ...
            new (4, 1, "Lettuce", "Vegetables", 2.0, 75, true, DateTime.Now.AddDays(-8), DateTime.Now.AddDays(-3), "Crisp green lettuce leaves."),
            new (5, 2, "Oranges", "Fruits", 2.8, 60, false, DateTime.Now.AddDays(-12), DateTime.Now.AddDays(-6), "Juicy navel oranges."),
            new (6, 3, "Potatoes", "Vegetables", 1.5, 150, true, DateTime.Now.AddDays(-25), DateTime.Now.AddDays(-12), "Fresh russet potatoes."),
            new (7, 1, "Strawberries", "Fruits", 4.5, 30, false, DateTime.Now.AddDays(-5), DateTime.Now.AddDays(-2), "Sweet seasonal strawberries."),
            new (8, 2, "Broccoli", "Vegetables", 3.2, 40, false, DateTime.Now.AddDays(-7), DateTime.Now.AddDays(-4), "Nutritious broccoli florets."),
            new (9, 3, "Bananas", "Fruits", 1.2, 80, true, DateTime.Now.AddDays(-18), DateTime.Now.AddDays(-9), "Ripe yellow bananas."),
            new (10, 1, "Spinach", "Vegetables", 2.3, 55, true, DateTime.Now.AddDays(-6), DateTime.Now.AddDays(-3), "Fresh baby spinach leaves.")
